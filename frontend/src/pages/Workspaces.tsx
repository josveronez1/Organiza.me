  ...
  return (
    <Layout>
        ...
        <div className="page-header">
          <div className="page-header-actions">
            <div>
              ...
              <p className="page-description">Organize seus projetos em diferentes áreas de trabalho</p>
            </div>
      ...
      <ConfirmModal
        ...
        message="Tem certeza que deseja excluir este workspace? Todos os boards e tarefas serão perdidos."
        confirmText="Excluir"
        variant="danger"
      />
    </Layout>
